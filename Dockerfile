...
CMD [ "/opt/echoip/echoip","--country-db", "/opt/echoip/GeoLite2-Country.mmdb", "--city-db", "/opt/echoip/GeoLite2-City.mmdb", "--port-lookup", "--reverse-lookup", "--log-level", "debug", "--trusted-header", "CF-Connecting-IP", "--trusted-header", "X-Forwarded-For", "--template", "/opt/echoip/index.html" ]